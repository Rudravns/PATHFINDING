            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    if event.button == 4:  #Scroll Up
                        ...
                        self.pathfinding_algorithm = (self.pathfinding_algorithm + 1) % len(algorithms.Pathfinding_Algorithm_types)

            pygame.display.flip()  # Update the display

    def draw_UI(self, grid_width):
        ...
        render_text(f"Type: {self.map.key[self.type]}", (grid_width + 20, 70), size=24, color="black", surface=self.screen)
        render_text(f"Algorithm: {algorithms.Pathfinding_Algorithm_types[self.pathfinding_algorithm]}", (grid_width + 20, 120), size=24, color="black", surface=self.screen)
